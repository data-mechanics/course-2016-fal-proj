...
Fig. 1: Crime Heat Map — We looked at the crime data and the output from Boston Grid Cell GPS Centers(1000-FT Cells). For each cell in 
...
![alt tag](http://i67.tinypic.com/2agl14.png)
