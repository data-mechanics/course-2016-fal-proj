...
class transformation7(dml.Algorithm):
    ...
    def execute(Trial=False):
        ...
        print('Finished combing weatherdata and citibike_data')
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:anuragp1_jl101995#transformation7', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
...
transformation7.execute(Trial=False)
