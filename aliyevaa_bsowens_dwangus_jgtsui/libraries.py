...
class libraries(dml.Algorithm):
    ...
    def execute(r, trial=False):
        ...
        print("Number of entries before dropping table: {}".format(
            repo.aliyevaa_bsowens_dwangus_jgtsui.libraries.count()))
		# return
        ...
        for elem in repo.aliyevaa_bsowens_dwangus_jgtsui.libraries.find(modifiers={"$snapshot": True}):
            lng = elem['lng']
            lat = elem['lat']
            repo.aliyevaa_bsowens_dwangus_jgtsui.libraries.update({'_id': elem['_id']}, {
        ...
        print(
            "Number of entries inserted into Mongo: {}".format(repo.aliyevaa_bsowens_dwangus_jgtsui.libraries.count()))
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:aliyevaa_bsowens_dwangus_jgtsui#libraries',
                                {prov.model.PROV_TYPE: prov.model.PROV['SoftwareAgent'], 'ont:Extension': 'py'})
        resource = doc.entity('bdp:city=Boston', {'prov:label': 'Boston libraries from Google Maps',
        ...
        found = doc.entity('dat:aliyevaa_bsowens_dwangus_jgtsui#libraries',
                           {prov.model.PROV_LABEL: 'Boston Parking from Google Maps',
