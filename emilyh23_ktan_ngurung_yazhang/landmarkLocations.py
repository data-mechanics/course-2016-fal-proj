...
class landmarkLocations(dml.Algorithm):
    ...
    reads = []
    writes = ['emilyh23_ktan_ngurung_yazhang.bigBelly', 'emilyh23_ktan_ngurung_yazhang.colleges', 'emilyh23_ktan_ngurung_yazhang.hubways', 'emilyh23_ktan_ngurung_yazhang.busStops', 'emilyh23_ktan_ngurung_yazhang.tStops', 'emilyh23_ktan_ngurung_yazhang.ridership']
    ...
    def execute(trial = False):
        ...
        repo['emilyh23_ktan_ngurung_yazhang.bigBelly'].insert_one(r0)
        ...
        repo['emilyh23_ktan_ngurung_yazhang.colleges'].insert_many(r1)
        ...
        repo['emilyh23_ktan_ngurung_yazhang.hubways'].insert_many(r2)
        ...
        repo['emilyh23_ktan_ngurung_yazhang.busStops'].insert_many(r3)
        ...
        repo['emilyh23_ktan_ngurung_yazhang.tStops'].insert_many(r4)
        ...
        repo['emilyh23_ktan_ngurung_yazhang.ridership'].insert_many(r5)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:emilyh23_ktan_ngurung_yazhang#landmarkLocations', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        colleges_resource = doc.entity('dat:emilyh23_ktan_ngurung_yazhang/colleges-and-universities', {'prov:label':'Colleges and Universities', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        hubways_resource = doc.entity('dat:emilyh23_ktan_ngurung_yazhang/hubway-stations-in-boston', {'prov:label':'Hubway Stations in Boston', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        busStops_resource = doc.entity('dat:emilyh23_ktan_ngurung_yazhang/mbta-bus-stops', {'prov:label':'MBTA Bus Stops', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        ...
        bigBelly = doc.entity('dat:emilyh23_ktan_ngurung_yazhang#bigBelly', {prov.model.PROV_LABEL:'Big Belly Locations Data', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        colleges = doc.entity('dat:emilyh23_ktan_ngurung_yazhang#colleges', {prov.model.PROV_LABEL:'Colleges and Universities Data', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        hubways = doc.entity('dat:emilyh23_ktan_ngurung_yazhang#hubways', {prov.model.PROV_LABEL:'Hubway Stations in Boston Data', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        busStops = doc.entity('dat:emilyh23_ktan_ngurung_yazhang#busStops', {prov.model.PROV_LABEL:'MBTA Bus Stops Data', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        tStops = doc.entity('dat:emilyh23_ktan_ngurung_yazhang#tStops', {prov.model.PROV_LABEL:'T-Stop Locations Data', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        ridership = doc.entity('dat:emilyh23_ktan_ngurung_yazhang#ridership', {prov.model.PROV_LABEL:'Boston T Ridership Data', prov.model.PROV_TYPE:'ont:DataSet'})
