...
class collegeBusStops(dml.Algorithm):
    ...
    writes = ['emilyh23_ktan_ngurung_yazhang.collegeBusStopCounts']
    ...
    def execute(trial = False):
        ...
        busStops = repo.emilyh23_ktan_ngurung_yazhang.busStops.find() 
        colleges = repo.emilyh23_ktan_ngurung_yazhang.colleges.find()
        ...
        repo['emilyh23_ktan_ngurung_yazhang.collegeBusStopCounts'].insert_one(r)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:emilyh23_ktan_ngurung_yazhang#collegeBusStops', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        collegeBusStops = doc.entity('dat:emilyh23_ktan_ngurung_yazhang#collegeBusStops', {prov.model.PROV_LABEL:'Number of Colleges And Bus Stops for Each Zip code', prov.model.PROV_TYPE:'ont:DataSet'})
