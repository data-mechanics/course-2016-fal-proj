...
class merge(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        hbbCounts = repo.ktan_ngurung_yazhang_emilyh23.hubwayBigBellyCounts.find() 
        cbsCounts = repo.ktan_ngurung_yazhang_emilyh23.collegeBusStopCounts.find()
        tRideCounts = repo.ktan_ngurung_yazhang_emilyh23.tRidershipLocation.find()
